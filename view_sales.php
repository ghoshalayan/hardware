                          ...
                          <div class="panel-body">
                            ...
                            <?php $i = 1;
                              if (isset($_POST['search'])) {
                                $from = $_POST["from"];
                                $to = $_POST["to"];
                                $sql_stock = mysqli_query($conn, "SELECT * FROM sales WHERE date(insert_date) BETWEEN '$from' AND '$to'");  
                              } else {
                                $sql_stock=mysqli_query($conn, "SELECT * FROM sales ORDER BY sales_id ASC");
                              }
                              while($show_stock = mysqli_fetch_array($sql_stock)) { ?>
                                <tr>
                                  <td><?php echo $i; ?></td>
